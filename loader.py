...
transform_L_small = transforms.Compose([
    transforms.Resize(256),
    transforms.CenterCrop(224),
...
transform_AB_small = transforms.Compose([
    transforms.Resize(256),
    transforms.CenterCrop(224),
    transforms.Resize(28),
    transforms.ToTensor(),
...
def main():
    ...
    dataset_AB_small = ImageFolder(root=dataset_dir, transform=transform_AB_small)

    dataset_L_small = ImageFolder(root=dataset_dir, transform=transform_L_small)
